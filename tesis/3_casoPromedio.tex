...
\item (1) Errores m\'aximos del sistema cuando modelo = TP: 

Min($Conf^{M2}_{TP}$, $P_{\mathcal{G}}(Conf^S = FN | Clase = P, \text{do}(Pred^{M2} = P))$ x $CantPositive$)

\item (2) Errores m\'aximos del sistema cuando modelo = TN:  

Min($Conf^{M2}_{TN}$, $P_{\mathcal{G}}(Conf^S = FP | Clase = N, \text{do}(Pred^{M2} = N))$ x $CantNegative$)
...
\item (3) Errores m\'aximos del sistema cuando modelo = FN: 

Min($Conf^{M2}_{FN}$,

\hspace*{0.5cm} $P_{\mathcal{G}}(Conf^S = FN | Clase = P, \text{do}(Pred^{M2} = N))$ x $CantPositive$ -

\hspace*{0.5cm} Min($Conf^{M2}_{TP}$, $P_{\mathcal{G}}(Conf^S = FN | Clase = P, \text{do}(Pred^{M2} = P))$ x $CantPositive$))

\item (4) Errores m\'aximos del sistema cuando modelo = FP: 

Min($Conf^{M2}_{FP}$,

\hspace*{0.5cm} $P_{\mathcal{G}}(Conf^S = FP | Clase = N, \text{do}(Pred^{M2} = P))$ x $CantNegative$ -

\hspace*{0.5cm} Min($Conf^{M2}_{TN}$, $P_{\mathcal{G}}(Conf^S = FP | Clase = N, \text{do}(Pred^{M2} = N))$ x $CantNegative$))
