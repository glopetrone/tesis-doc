...
La siguiente tabla tiene para con conjunto de instancias de ejemplo de clase Positive, que resultado tendr\'ia el sistema en caso del modelo predecir Positive o Negative. Se marca con una X las instancias donde el sistema falla. La suma de la cantidad de X por columna son los valores con intervenci\'on analizados anteriormente (\IPFN y \INFN). Se busca ilustrar que casos no son v\'alidos en base a las assumptions planteadas.\\
\vspace{3mm}
...
\vspace{3mm}
{$\{i\in d$ $|$ $ d_{2}=0 \land S(I)=0 \land M(I)=1\}$ $\subseteq$
