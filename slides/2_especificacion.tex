...
\vspace{6mm}
Se espera lo siguiente sobre el comportamiento del sistema para cualquier conjunto de instancias $D$:\\
\vspace{4mm}
...
% \vspace{2mm}
% \item {$\{d\in D$ $|$ $ d_{2}=0 \land S(d_{1})=1 \}$ $\subseteq$

% $\{d\in D$ $|$ $ d_{2}=0 \land S_{*\rightarrow n}(d_{1})=1 \}$}
% \vspace{2mm}
% \item {$\{d\in D$ $|$ $ d_{2}=1 \land S(d_{1})=1 \}$ $\subseteq$

% $\{d\in D$ $|$ $ d_{2}=1 \land S_{*\rightarrow n}(d_{1})=1 \}$}
% \vspace{2mm}
% \item {$\{d\in D$ $|$ $ d_{2}=1 \land S(d_{1})=0 \}$ $\subseteq$

% $\{d\in D$ $|$ $ d_{2}=1 \land S_{*\rightarrow p}(d_{1})=0 \}$}
\end{itemize}
\vspace{4mm}
...
El problema se va a trabajar como un problema de b\'usqueda. \\
\vspace{3mm}
\begin{itemize}
\item El espacio de b\'usqueda van a ser todas las posibles combinaciones de resultados de clasificaci\'on en el sistema sobre las instancias disponibles.
\item El objetivo va a ser hallar los conjuntos de resultados donde la cantidad de fallos sea m\'axima y se cumpla la especificaci\'on planteada
\end{itemize}
\end{frame}
...
% Primero se va a acotar el espacio de b\'usqueda con informaci\'on \'unicamente de las intervenciones, descartando espacios inalcanzables.
% \end{frame}
...
% \vspace{3mm}
% Ahora dentro del espacio resultante, teniendo en cuenta el modelo, se van a descartar casos donde se pueda ver que no son los peores y existan otros con mas fallos. Para lograr esto se va a analizar de forma m\'as cercana los comportamientos posibles de las instancias.
% \end{frame}