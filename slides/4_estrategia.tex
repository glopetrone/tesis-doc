...
\vspace{3mm}
La estrategia del adversario entonces va a consistir en inflar la cantidad de instancias de tipo 3 en las que el modelo falla, para con eso provocar el fallo en el sistema. \\
\vspace{3mm}
Las instancias de tipo 1 y 4 son irrelevantes para el adversario por lo que las puede asignar tanto a aciertos, como a los fallos restantes del modelo.
\end{frame}
...
\vspace{3mm}
\begin{itemize}
\item La cantidad de fallos del modelo es la confusion de Falsos Negativos
\end{itemize}
\end{frame}
