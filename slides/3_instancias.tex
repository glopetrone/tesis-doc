...
\begin{frame}
\frametitle{Comportamiento de instancias}
Recordando la assumption de la clase Positive:\\
\vspace{3mm}
...
\begin{table}[]
    \begin{tabular}{c|c|c|c|}
        & \CIP & \CIN & ¿Es factible? \\ \hline
        \rowcolor{green!25} Tipo 1 & p & p & SI \\ \hline
                            Tipo 2 & n & p &    \\ \hline
                            Tipo 3 & p & n &    \\ \hline
                            Tipo 4 & n & n &    \\ \hline
    \end{tabular}
...
\begin{table}[]
    \begin{tabular}{c|c|c|c|}
        & \CIP & \CIN & ¿Es factible? \\ \hline
                            Tipo 1 & p & p & SI \\ \hline
        \rowcolor{red!25}   Tipo 2 & n & p & NO \\ \hline
                            Tipo 3 & p & n &    \\ \hline
                            Tipo 4 & n & n &    \\ \hline
    \end{tabular}
    \caption{Resultados posibles en instancias de clase Positive}
...
\begin{table}[]
    \begin{tabular}{c|c|c|c|}
        & \CIP & \CIN & ¿Es factible? \\ \hline
                            Tipo 1 & p & p & SI \\ \hline
                            Tipo 2 & n & p & NO \\ \hline
        \rowcolor{green!25} Tipo 3 & p & n & SI \\ \hline
                            Tipo 4 & n & n &    \\ \hline
    \end{tabular}
    \caption{Resultados posibles en instancias de clase Positive}
\end{table}
...
\begin{table}[]
    \begin{tabular}{c|c|c|c|}
        & \CIP & \CIN & ¿Es factible? \\ \hline
                            ...
                            Tipo 2 & n & p & NO \\ \hline
                            Tipo 3 & p & n & SI \\ \hline
        \rowcolor{green!25} Tipo 4 & n & n & SI \\ \hline
    \end{tabular}
    \caption{Resultados posibles en instancias de clase Positive}
\end{table}
\end{frame}
